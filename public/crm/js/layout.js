(function () {
  ...
  const APP_NAME = 'CRM';
  const NAV = [
    { href: '/crm', icon: '📊', label: 'Dashboard', page: 'crm-home' },
    { href: '/crm/klien', icon: '👤', label: 'Klien', page: 'crm-klien' },
    { href: '/crm/pipeline', icon: '📈', label: 'Pipeline', page: 'crm-pipeline' },
    { href: '/crm/aktivitas', icon: '📞', label: 'Aktivitas', page: 'crm-aktivitas' },
    { href: '/crm/laporan', icon: '📋', label: 'Laporan', page: 'crm-laporan' },
  ];
