(function () {
  ...
  const NAV = [
    { href: '/dokumen', icon: '📊', label: 'Dashboard', page: 'dokumen-home' },
    { href: '/dokumen/arsip', icon: '📄', label: 'Arsip Dokumen', page: 'dokumen-arsip' },
    { href: '/dokumen/upload', icon: '⬆️', label: 'Upload', page: 'dokumen-upload' },
    { href: '/dokumen/kategori', icon: '🗂️', label: 'Kategori', page: 'dokumen-kategori' },
  ];
